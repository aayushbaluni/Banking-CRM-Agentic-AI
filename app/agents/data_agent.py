...
def _needs_clarification(state: AgentState) -> tuple[bool, str]:
    ...
    check_prompt = (
        ...
        '- "car loan customers" = customers without auto loan, income ≥ ₹25k\n'
        '- "home loan customers" = customers without home loan, income ≥ ₹35k\n'
        '- "business loan customers" = business owners without existing business loan\n'
        '- No city = all cities. No income = min ₹25,000\n\n'
        'ONLY ask for clarification if the query contains jargon whose meaning\n'
        'you genuinely CANNOT infer from banking context.\n\n'
        ...
        'CLARIFY examples (genuinely unknown):\n'
